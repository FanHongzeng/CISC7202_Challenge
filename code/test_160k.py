...
image_datasets = {}
image_datasets['gallery_satellite'] = CustomData160k_sat(os.path.join(data_dir, 'gallery_satellite'), data_transforms)
image_datasets['query_street'] = CustomData160k_drone( os.path.join(data_dir,'query_street') ,data_transforms, query_name = query_name)
...
if __name__ == "__main__":
    ...
    save_filename = 'answer_top10.txt' #'results_rank10.txt' 
